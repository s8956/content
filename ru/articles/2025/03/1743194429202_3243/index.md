...
```bash
"${HOME}/apps/acme/lego" --accept-tos --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='mail.example.com' --http --http.webroot='/var/www/html' run
```
...
```bash
"${HOME}/apps/acme/lego" --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='mail.example.com' --http --http.webroot='/var/www/html' --renew-hook="${HOME}/apps/acme/hook.sh" renew
```
...
```bash
CF_DNS_API_TOKEN='TOKEN'; "${HOME}/apps/acme/lego" --accept-tos --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='*.example.com' --dns='cloudflare' --dns.resolvers '1.1.1.1:53' --dns.resolvers '8.8.8.8:53' --dns.resolvers '77.88.8.8:53' run
```
...
```bash
CF_DNS_API_TOKEN='TOKEN'; "${HOME}/apps/acme/lego" --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='*.example.com' --dns='cloudflare' --dns.resolvers '1.1.1.1:53' --dns.resolvers '8.8.8.8:53' --dns.resolvers '77.88.8.8:53' --renew-hook="${HOME}/apps/acme/hook.sh" renew
```
...
```bash
"${HOME}/apps/acme/lego" --accept-tos --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='mail.example.com' --tls --tls.port='10443' run
```
...
```bash
"${HOME}/apps/acme/lego" --path='/etc/ssl/acme' --email='mail@example.com' --domains='example.com' --domains='mail.example.com' --tls --tls.port='10443' --renew-hook="${HOME}/apps/acme/hook.sh" renew
```
