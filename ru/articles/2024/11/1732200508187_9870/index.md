...
```bash
pg_dump --host='127.0.0.1' --port='5432' --username='zabbix' --password --dbname='zabbix' --file='zabbix.backup.sql'
```
...
sudo -u 'postgres' psql --dbname 'zabbix' --file='zabbix.backup.sql'
